  ...
  return (
    <div>
      <div className="container rounded-2xl bg-white/10 py-11">
        <div className="font-PoppinsExtraBold text-2xl">Services</div>
          ...
          {mentalHealthConditions.map((item, index) => {
            return (
              <div
                ...
                key={item.id}
              >
                <h2 className="font-PoppinsBold text-xl md:text-2xl">{item.name}</h2>
                <h3 className="font-PoppinsMedium text-lg md:text-xl">{item.title}</h3>
